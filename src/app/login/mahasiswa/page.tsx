...
export default function StudentLoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            const result = await loginAction({ role: "STUDENT", userId, password });
            ...
            toast.success("Login Mahasiswa berhasil!");
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center bg-white overflow-hidden font-sans">
            <PageTitle title="Login Mahasiswa" />

            {/* Premium Background Decorations */}
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-[-10%] right-[-5%] w-[50%] h-[50%] bg-blue-600/5 rounded-full blur-[120px] animate-pulse" />
                <div className="absolute bottom-[-10%] left-[-5%] w-[40%] h-[40%] bg-indigo-600/5 rounded-full blur-[120px] animate-pulse delay-1000" />
            </div>
                        ...
                        <div className="relative z-10 space-y-10">
                            ...
                            <div className="space-y-4 text-center">
                                ...
                                <div className="space-y-2">
                                    <p className="text-[10px] font-black text-blue-600 uppercase tracking-[0.4em]">Portal Mahasiswa</p>
                                    <h1 className="text-3xl font-black text-slate-900 tracking-tight leading-none italic">LOG IN.</h1>
                                </div>
                            </div>
                            ...
                            <p className="text-center text-[9px] font-bold text-slate-300 uppercase tracking-widest leading-relaxed">
                                SIAKAD SYSTEM • OFFICIAL STUDENT PORTAL<br />
