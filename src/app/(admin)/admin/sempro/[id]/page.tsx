...
import { ChevronLeft, AlertCircle, Save, Loader2, User, UserPlus, FileText, ExternalLink, Users } from "lucide-react";
...
export default function AdminSemproDetail({ params }: { params: Promise<{ id: string }> }) {
    ...
    const { logs: guidanceLogs, isLoading: loadingGuidance } = useGuidanceLogs(sempro?.skripsi_id || undefined);
    ...
    const pengujiKetuaOptions = useMemo(() =>
        sempro?.penguji_ketua && sempro?.nama_penguji_ketua ? [{
    ...
    const penguji1Options = useMemo(() =>
        sempro?.penguji_1 && sempro?.nama_penguji_1 ? [{
    ...
    const penguji2Options = useMemo(() =>
        sempro?.penguji_2 && sempro?.nama_penguji_2 ? [{
                            ...
                            <div className="grid sm:grid-cols-1 gap-4 pt-6 border-t border-slate-50">
                                ...
                                {sempro.file_path ? (
                                    <a
                                        ...
                                        className="h-20 flex items-center px-6 font-black gap-4 rounded-3xl border border-slate-100 bg-slate-50/30 hover:bg-slate-900 hover:text-white transition-all shadow-sm group w-full"
                                    >
                                        ...
                                        <div className="text-left">
                                            ...
                                            <p className="text-sm">File Proposal (.pdf)</p>
                                        </div>
                            ...
                            <CardContent className="px-8 sm:px-10 space-y-8 pb-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-3">
                                        ...
                                        <TimePicker
                                            value={form.jam}
                                            onChange={(val) => setForm({ ...form, jam: val })}
                                        />
                                    </div>
                                    <div className="space-y-3">
